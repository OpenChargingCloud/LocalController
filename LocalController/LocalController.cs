...
namespace cloud.charging.open.LocalController
{
    ...
    public partial class LocalController : IAsyncDisposable
    {
        ...
        /// <summary>
        /// How many of those servers this local controller was told must
        /// answer: by the last section that named "minServers", or the default
        /// of two.
        /// </summary>
        /// <remarks>
                               ...
                               TimeProvider?          TimeProvider      = null)
        {
            ...
            // The four this controller asks when nobody says otherwise - but
            // only when nobody handed it a client either. A caller that named
            // its own server means that server, and a group naming four others
        ...
        /// <summary>
        /// Let somebody else decide when this local controller's log may write
        /// on the console, because they are writing on it too.
        /// </summary>
        /// <remarks>
        /// A controller at a console assumes the console is its own and writes
        /// an entry whenever one happens, from whichever thread it happened on.
